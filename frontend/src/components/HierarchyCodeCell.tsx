    ...
    <div className={cn("flex items-start gap-1", className)} style={{ paddingLeft: `${depth * 0.75}rem` }}>
      {hasChildren ? (
        <button
          type="button"
          onClick={onToggle}
          className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded text-ink-muted hover:bg-surface-3 hover:text-ink focus:outline-none focus:ring-2 focus:ring-brand-400/60"
